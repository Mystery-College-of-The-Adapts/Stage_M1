...
/* AJOUT */
import net.corda.core.crypto.FalconProvider
/* FIN AJOUT */
...
internal val falconProvider = FalconProvider().also {
    Security.addProvider(it)
}
...
internal val providerMap = listOf(cordaBouncyCastleProvider, cordaSecurityProvider, bouncyCastlePQCProvider, falconProvider/* AJOUT */).map { it.name to it }.toMap()
